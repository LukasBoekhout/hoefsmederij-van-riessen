    ...
    const blogPosts = [
        {
            ...
            excerpt:
                "Hoe de juiste voeding kan bijdragen aan sterke en gezonde hoeven bij uw paard.",
            date: "15 maart 2023",
        ...
        },
        {
            ...
            excerpt:
                "Praktische tips om hoeven gezond te houden tijdens warme en droge zomermaanden.",
            date: "2 juni 2023",
        ...
        },
        {
            ...
            excerpt:
                "Een overzicht van de nieuwste ontwikkelingen en materialen in de wereld van hoefbeslag.",
        ...
        },
        {
            ...
            excerpt:
                "Leer de vroege waarschuwingssignalen van veelvoorkomende hoefproblemen herkennen.",
        ...
        },
        {
            ...
            excerpt:
                "Speciale aandachtspunten voor hoefverzorging tijdens de koude wintermaanden.",
        ...
        },
        {
            ...
            excerpt:
                "Waarom consistente verzorging essentieel is voor de gezondheid van uw paard.",
    ...
    return (
        <main className="min-h-screen bg-white pt-24">
            <PageTransition>
                <PageHeader
                    title="Blog"
                    subtitle="Artikelen en inzichten over hoefverzorging en paardenwelzijn"
                />
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/60 to-transparent">
                                            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                                                ...
                                                <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
                                                    Moderne technieken in
                                                    hoefverzorging: een complete
                                                    gids
                                                </h2>
                                                <p className="text-slate-200 mb-4 max-w-2xl">
                                                    Een diepgaande verkenning
                                                    van de nieuwste methoden en
                                                    technieken in
                                                    hoefverzorging, inclusief de
                                                    voordelen van verschillende
                                                    benaderingen voor
                                                    verschillende paardenrassen.
                                                </p>
                            ...
                            <div className="mt-12 bg-amber-100 rounded-xl p-8 shadow-lg relative overflow-hidden">
                                ...
                                <div className="relative z-10 max-w-2xl">
                                    ...
                                    <p className="text-slate-700 mb-6">
                                        ...
                                        ontvang regelmatig tips, nieuws en
                                        aanbiedingen over hoefverzorging.
                                    </p>
                                    ...
                                    <p className="text-slate-600 text-sm mt-3">
                                        We respecteren uw privacy. U kunt zich
                                        op elk moment uitschrijven.
                                    </p>
                                </div>
                            </div>
                        </div>

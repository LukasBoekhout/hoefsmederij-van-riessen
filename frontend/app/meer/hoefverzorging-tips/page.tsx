                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                                ...
                                <div className="flex flex-col justify-center">
                                    ...
                                    <p className="text-slate-600 mb-4">
                                        Regelmatige verzorging van de hoeven is
                                        essentieel voor de gezondheid van uw
                                        paard. Hier zijn enkele tips voor
                                        dagelijkse verzorging.
                                    </p>
                                    <ul className="space-y-2">
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                Reinig de hoeven dagelijks met
                                                een hoevenkrabber
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                Controleer op steentjes, glas of
                                        ...
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                Let op tekenen van infectie of
                                                beschadiging
                                            </span>
                                        </li>
                                    </ul>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="bg-white rounded-lg shadow-md overflow-hidden border border-slate-200 transform transition-transform hover:scale-105 hover:rotate-1">
                                    <div className="p-6">
                                        ...
                                        <p className="text-slate-600">
                                            De juiste voeding is essentieel voor
                                            sterke en gezonde hoeven. Zorg voor
                                            voldoende biotine en mineralen.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg shadow-md overflow-hidden border border-slate-200 transform transition-transform hover:scale-105 hover:-rotate-1">
                                    <div className="p-6">
                                        ...
                                        <p className="text-slate-600">
                                            Regelmatige beweging op
                                            verschillende ondergronden
                                            stimuleert de bloedsomloop en
                                            bevordert gezonde hoeven.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-lg shadow-md overflow-hidden border border-slate-200 transform transition-transform hover:scale-105 hover:rotate-1">
                                    <div className="p-6">
                                        ...
                                        <p className="text-slate-600">
                                            Leer de signalen herkennen wanneer
                                            professionele hulp nodig is voor de
                                            hoeven van uw paard.
                                        </p>
                                    </div>
                                </div>

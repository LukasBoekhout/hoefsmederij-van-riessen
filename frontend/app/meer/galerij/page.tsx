    ...
    return (
        <main className="min-h-screen bg-white pt-24">
            <PageTransition>
                <PageHeader
                    title="Galerij"
                    subtitle="Een visuele impressie van ons werk en vakmanschap"
                />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="bg-slate-100 rounded-lg overflow-hidden shadow-md">
                                        ...
                                        <div className="p-4">
                                            <h3 className="font-bold text-slate-800">
                                                Bekappen Demonstratie
                                            </h3>
                                            <p className="text-slate-600 text-sm mt-1">
                                                Een demonstratie van het
                                                bekappen van paardenhoeven
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-slate-100 rounded-lg overflow-hidden shadow-md">
                                        ...
                                        <div className="p-4">
                                            ...
                                            <p className="text-slate-600 text-sm mt-1">
                                                Het op maat maken van een
                                                hoefijzer voor optimale pasvorm
                                            </p>
                                        </div>
                                    </div>
                                </div>

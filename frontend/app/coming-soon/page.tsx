      ...
      <PageTransition>
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              We zijn momenteel bezig met het ontwikkelen van deze pagina. Kom binnenkort terug voor meer informatie.
            </motion.p>
            ...
            >
              <h2 className="text-xl font-bold text-slate-800 mb-4">Wat kunt u verwachten?</h2>
              <ul className="space-y-3 text-left">
                <li className="flex items-start">
                  ...
                  <span className="text-slate-600">Gedetailleerde informatie over onze diensten</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-5 h-5 text-amber-600 mr-2 mt-0.5"
                  ...
                  <span className="text-slate-600">Nuttige tips voor hoefverzorging</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-5 h-5 text-amber-600 mr-2 mt-0.5"
                  ...
                  <span className="text-slate-600">Foto's van ons werk</span>
                </li>
                <li className="flex items-start">
                  <svg
                    className="w-5 h-5 text-amber-600 mr-2 mt-0.5"
                  ...
                  <span className="text-slate-600">Mogelijkheid om online afspraken te maken</span>
                </li>
              </ul>
            </motion.div>
          </div>

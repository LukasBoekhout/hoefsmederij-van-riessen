        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <motion.div
              ...
              style={{ x: horseshoePosition.x, y: horseshoePosition.y }}
            >
              <svg
          ...
          >
            <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.3 }}>
              4
            </motion.span>
            <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.5 }}>
              0
            </motion.span>
            <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.7 }}>
              4
            </motion.span>
            <motion.span
              initial={{ opacity: 0 }}
          ...
          >
            Oeps! Het lijkt erop dat deze hoef niet te vinden is. De pagina die u zoekt bestaat niet of is verplaatst.
          </motion.p>
          ...
          >
            <h2 className="text-xl font-bold text-slate-800 mb-4">Misschien bent u op zoek naar:</h2>
            <ul className="space-y-2">
              {[
                ...
                >
                  <Link href={link.href} className="text-amber-600 hover:text-amber-700 flex items-center group">
                    <motion.svg

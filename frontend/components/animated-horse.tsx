  ...
  return (
    ...
    >
      <div className="relative w-24 h-24 md:w-32 md:h-32">
        ...
        >
          ...
          <path
            ...
            strokeLinecap="round"
          />
          <path d="M12 9C12 9 12 12 10 12C8 12 8 9 8 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          <path d="M5 9C5 9 5 12 3 12C1 12 1 9 1 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          <path d="M17 12L17 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          <path d="M10 12L10 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          <path d="M3 12L3 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          <path d="M17 16L23 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        </svg>
      </div>
      ...
      {isHovered && (
        ...
        >
          <p className="text-sm">Professionele hoefverzorging sinds 1995</p>
        </motion.div>
      )}
    </motion.div>
  )

        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-slate-300">
              Professionele hoefsmederij met meer dan 30 jaar ervaring in het bekappen en beslaan van paarden.
            </p>
            <div className="pt-2">
              <p className="text-amber-400 font-semibold">Rijksgediplomeerd Hoefsmid sinds 1995</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="flex items-center hover:text-amber-300 transition-colors">
                  <svg
                    className="w-5 h-5 text-amber-400 mr-2"
                    fill="none"
                    stroke="currentColor"
              ...
              <li>
                <Link href="/composiet-beslag" className="flex items-center hover:text-amber-300 transition-colors">
                  <svg
                    className="w-5 h-5 text-amber-400 mr-2"
                    fill="none"
                    stroke="currentColor"
              ...
              <li>
                <Link href="/witte-lijn-straalrot" className="flex items-center hover:text-amber-300 transition-colors">
                  <svg
                    className="w-5 h-5 text-amber-400 mr-2"
                    fill="none"
                    stroke="currentColor"
              ...
              <li>
                <Link href="/contact" className="flex items-center hover:text-amber-300 transition-colors">
                  <svg
                    className="w-5 h-5 text-amber-400 mr-2"
                    fill="none"
                    stroke="currentColor"
              ...
              <li>
                <Link href="/privacy" className="flex items-center hover:text-amber-300 transition-colors">
                  <svg
                    className="w-5 h-5 text-amber-400 mr-2"
                    fill="none"
                    stroke="currentColor"
              ...
              <li>
                <Link href="/terms" className="flex items-center hover:text-amber-300 transition-colors">
                  <svg
                    className="w-5 h-5 text-amber-400 mr-2"
                    fill="none"
                    stroke="currentColor"

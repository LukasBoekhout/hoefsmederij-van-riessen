...
const formSchema = z.object({
  ...
  subject: z.string().min(2, { message: "Onderwerp moet minimaal 2 karakters bevatten" }),
...
export function ContactForm() {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-8 rounded-lg shadow-md border border-slate-200">
